...
;; Define LET language with only number type, treat 0 as false and all
;; other values as true. See exercise 3.06 for reference.
...
(check-expect (run program4) (num-val 5))
(check-expect (run program5) (num-val 7))
