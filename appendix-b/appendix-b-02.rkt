...
;; The reason that we can not use a separated-list in or language
;; is that {Additive-op Arith-term}* and {Multiplicative-op Arith-factor}*
;; have non terminal symbol instead of have the same separated symbol
;; consider the following program

(define program2 "3 + 2 * 65 / 42 * 3 / 4 + 5")
